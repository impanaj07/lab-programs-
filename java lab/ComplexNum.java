...
ComplexNumber(double a)//parameterized constructor with one param
{
    real=a;
    imag=0.0;
}
ComplexNumber(double a ,double b)//parametrized constructor with two param
{
    real=a;
    imag=b;
}
ComplexNumber(ComplexNumber ob)//when you want to create an object with the same values of an existing instance
{
    real=ob.real;
    imag=ob.imag;
}
...
public class ComplexNum{
    public static void main(String[] args) {
        ...
        ComplexNumber cn3=new ComplexNumber(10 ,30);
